-- process_rma_resolution creditava a carteira com source_type='rma', valor não permitido pela
-- constraint customer_wallet_transactions_source_type_check (só aceita manual/adjustment/order/
-- refund/voucher/topup/other/campaign:%). Passa a usar 'refund' (semanticamente correto).
