  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Captura leads de diretórios de negócio (via Outscraper / Google Maps)."
        ...
        <CardContent className="p-4 grid md:grid-cols-3 gap-3">
          ...
          <div className="flex items-end">
            <Button onClick={search} disabled={searching || !canWrite}>
              {searching ? <Loader2 className="h-4 w-4 mr-2 animate-spin" /> : <Search className="h-4 w-4 mr-2" />}Procurar leads
            </Button>
          </div>
        </CardContent>
      </Card>
